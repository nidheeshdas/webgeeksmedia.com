          ...
          <div className="md:hidden mt-4 pb-4">
            <nav className="flex flex-col space-y-4">
              <div className="flex items-center space-x-1 text-gray-700">
                <Link to="/audit-service/"><span>Services</span></Link>
                {/* <ChevronDown className="w-4 h-4" /> */}
              </div>
              <Button onClick={() => navigate('/contact-us')} className=" text-white px-6 py-2 rounded-full w-fit rounded-[30px] border-2 border-[#E67474] text-[#E67474] hover:bg-[#E67474]/10 transition-colors">
                Connect with us
              </Button>
            </nav>
          </div>
