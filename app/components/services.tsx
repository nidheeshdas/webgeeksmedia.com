...
,
  ...
  {
    icon: () => <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M3.86621 13.8155C3.63608 13.8922 3.42696 14.0214 3.25543 14.193C3.0839 14.3645 2.95465 14.5736 2.87793 14.8037L0 23.4375L0.229004 23.6665L4.76465 19.1309C4.73242 19.0059 4.68799 18.8853 4.68799 18.75C4.68799 17.8872 5.38769 17.1875 6.25049 17.1875C7.11328 17.1875 7.81299 17.8872 7.81299 18.75C7.81299 19.6128 7.11328 20.3125 6.25049 20.3125C6.11523 20.3125 5.99463 20.2681 5.86963 20.2359L1.33398 24.7715L1.5625 25L10.1963 22.1221C10.4265 22.0455 10.6356 21.9162 10.8072 21.7447C10.9787 21.5731 11.1079 21.364 11.1846 21.1338L12.7993 17.0288L7.97119 12.2007L3.86621 13.8155ZM18.0298 1.38284L9.08887 11.1236L13.8667 15.9014L23.6074 6.96048C27.7539 3.29495 21.6665 -2.73142 18.0298 1.38284Z" fill="white" />
    </svg>
,
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {services.map((service, index) => (
            <div
              key={index}
              className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 hover:shadow-md transition-all duration-300 hover:-translate-y-1 relative"
            >
              {/* Status Badge */}
              {service.status && (
              ...
              {/* Title */}
              <h3 className="text-xl font-bold text-blue-600 mb-4 leading-tight">{service.title}</h3>
