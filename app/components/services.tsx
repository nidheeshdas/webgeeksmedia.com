      ...
      <div className="container mx-auto px-4 py-[80px]">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {services.map((service, index) => (
            <div
              key={index}
              className={`p-6 rounded-[20px] border-r-[4px] border-b-[4px] border-[#D7C8FF] bg-white shadow-sm hover:shadow-md transition-all duration-300 ${
                service.status !== "Upcoming"
                  ? "hover:-translate-y-1 hover:bg-transparent hover:[background-image:linear-gradient(139deg,#E1E3FF_0%,#E3FFCE_100%)]"
                  : ""
              } relative lg:w-[285px] h-auto`}
            >
              {/* Status Badge */}
              {service.status && (
